...
/**
  ...
  *
  ******************************************************************************
  *variant 2 - Blink 3 leds in separate threads
  *led1 freq = 10hz, time on = 50ms
  *led2 freq = 4hz, time on = 150ms
  *led3 freq = 2hz, time on = 300ms
  *button presses change led 1 time on from 50 ms to 200 ms
  *
  *CONNECTIONS
  *led1 - PA8
  *led2 - PA9
