...
/* Definitions for LedBtn */
osThreadId_t LedBtnHandle;
const osThreadAttr_t LedBtn_attributes = {
  .name = "LedBtn",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
int main(void)
{
  ...
  /* creation of LedBtn */
  LedBtnHandle = osThreadNew(StartLedBtn, NULL, &LedBtn_attributes);
...
/* USER CODE BEGIN Header_StartLedBtn */
/**
* @brief Function implementing the LedBtn thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLedBtn */
void StartLedBtn(void *argument)
{
  /* USER CODE BEGIN StartLedBtn */
  /* Infinite loop */
  for(;;)
  {
	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_11));
  }
  /* USER CODE END StartLedBtn */
}
